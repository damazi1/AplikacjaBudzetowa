...
Git umożliwia również pracę w grupach dzięki systemowi tworzenia gałęzi (ang. \textit{branches}), które pozwalają na równoległą pracę całego zespołu. Zakończone części kodu mogą być scalone poleceniem \texttt{merge} z główną gałęzią.
