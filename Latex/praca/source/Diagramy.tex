...
\begin{longtable}{|c|p{3.1cm}|p{9.9cm}|}
	...
	3. & Wydajność & System reaguje na żądanie w czasie krótszym niż 0.25 sekundy. Może obsłużyć do 1000 użytkowników jednocześnie. System jest w stanie przetworzyć do 10 GB na godzinę.  System jest skalowalny.\\ \hline
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1\linewidth]{images/Mermaid_ClassDiag}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{images/MermaidSeqDiag}
	\caption{Diagram sekwencji - Nowa transakcja portfela}
	\label{fig:Seq1}
\end{figure}


\subsection{TODO: Pomysły i nie użyte rzeczy}
