...
Dane zebrane przez stronę CoinLaw przedstawiają, że aplikacje do wspomagania budżetem domowym są najczęściej wykorzystywane w~przedziale wiekowym od 27 do 42 lat (91\%). Kolejna grupa to osoby w~wieku od 43 do 58 lat (80\%). W~przedziale od 18 do 26 roku życia jest to 68\% \cite{FintechStats}. Aktualna wielkość rynku dla technologii finansowych jako usługi (ang. \textit{Fintech as a~Service}) wynosi około 441,47 miliardów dolarów i~przy aktualnym tempie wzrostu może urosnąć nawet do 906,64 miliardów dolarów do 2030 roku \cite{FaaS}.
...
Pracę otwiera Wstęp, w którym uzasadniono istotność podejmowanego tematu. Przedstawiono w nim dane o wykorzystaniu aplikacji wspomagających zarządzanie budżetem domowym oraz zakres zadań jakie powinna spełniać aplikacja.
...
W rozdziale piątym zaprezentowano informację o sposobie implementacji systemu. Opisano działanie poszczególnych warstw aplikacji, w~jaki sposób odbywa się przepływ danych, funkcję oferowane przez system oraz komunikaty zwracane przez serwer. 
