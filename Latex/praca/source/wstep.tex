...
W celu analizy jakości aplikacji do zarządzania finansami osobistymi przeprowadzono badanie na grupie 301 Polaków, z~których 288 przyznało, że korzysta z~aplikacji do wspomagania budżetem, a~tylko 13, że nie korzysta. Główne czynności, do których Polacy wykorzystują aplikacje to Kontrola budżetu domowego (88,54\%), Weryfikacja wydatków z~ostatniego miesiąca (86,11\%), Sprawdzanie salda (48,26\%) oraz planowanie wydatków na kilka miesięcy (45,83\%) \cite{PFMApp}.
...
Dane są przechowywane w~nierelacyjnej bazie danych MongoDB, która zawiera dokumenty JSON z ważnymi informacjami, które są związane z~użytkownikami aplikacji.

Aplikacja uruchamiana jest z~poziomu platformy docker.
\section{Struktura pracy}
Pracę otwiera Wstęp, w~którym uzasadniono istotność podejmowanego tematu. Przedstawiono w~nim dane o~aplikacjach wspomagających zarządzanie budżetem domowym oraz zakres funkcjonalności, jakie powinna dostarczać aplikacja.
