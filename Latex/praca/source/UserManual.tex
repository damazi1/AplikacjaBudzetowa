...
Wyświetlone zostaną wszystkie portfele i~konta bankowe użytkownika oraz~podsumowanie danych na wykresach. Z~poziomu strony głównej można również utworzyć nowy portfel lub dodać konto bankowe (rys. \ref{fig:newwalletmodal}, \ref{fig:newaccountmodal}). 
