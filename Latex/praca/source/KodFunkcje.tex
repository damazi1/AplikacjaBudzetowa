...
Odpowiednie przygotowanie danych do wykresów jest kluczową częścią projektu. Zostało to osiągnięte z wykorzystaniem mechanizmu strumieni. Strumienie przetwarzają, filtrują i~dokonują operacji na zbiorze danych.
